...
import 'package:ai_notes_taker/ui/views/auth/auth_screen.dart' as _i4;
...
import 'package:ai_notes_taker/ui/views/voice/reminders_list.dart' as _i6;
import 'package:ai_notes_taker/ui/views/voice/voice_view.dart' as _i5;
...
class Routes {
  ...
  static const aINotesApp = '/a-inotes-app';
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i4.AINotesApp: (data) {
      return _i7.MaterialPageRoute<dynamic>(
        builder: (context) => const _i4.AINotesApp(),
        settings: data,
      );
    },
    _i5.VoiceView: (data) {
      return _i7.MaterialPageRoute<dynamic>(
        builder: (context) => const _i5.VoiceView(),
        settings: data,
      );
    },
    _i6.RemindersListScreen: (data) {
      return _i7.MaterialPageRoute<dynamic>(
        builder: (context) => const _i6.RemindersListScreen(),
        settings: data,
      );
    },
  };
...
extension NavigatorStateExtension on _i8.NavigationService {
  ...
  Future<dynamic> navigateToAINotesApp([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.aINotesApp,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithAINotesApp([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return replaceWith<dynamic>(Routes.aINotesApp,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
